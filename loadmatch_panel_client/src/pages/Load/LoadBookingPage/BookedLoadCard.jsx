...
import "./style.css";
const BookedLoadCard = ({ load }) => {
  return (
    <div className="shrink-0 p-1 rounded-xl    w-full mx-auto bg-white  h-fit  grid grid-cols-3   shadow-green-50 ">
