...
const SpaceCard = ({ space }) => {
  ...
  return (
    <div className="shrink-0 rounded-xl shadow-md  w-[50%]   bg-white min-h-32 h-fit grid grid-cols-1 shadow-green-50">
      <div className="images h-fit   w-[80%] mx-auto ml-4 col-span-1">
      ...
      <div className="details text-gray-800 mx-2 rounded-md py-1 col-span-2 flex flex-col gap-0.5">
        ...
        <div className="mt-1 p-1 flex gap-4">
          <div className="text-slate-500 text-[12px] font-semibold text-center">
            ...
            <div className="text-[10px]">{`${space.width}×${space.height}×${space.length} ft`}</div>
          </div>
          <div className="mb-1 leading-3 text-slate-500 text-[12px] font-semibold text-center">
            ...
            <div className="text-[10px]">{`${space.weight} tons`}</div>
          </div>
        </div>
      </div>
    </div>
